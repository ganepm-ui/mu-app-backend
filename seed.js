...
const places = [
    ...
    {
        name: "วัดแขก",
        image: "https://upload.wikimedia.org/wikipedia/commons/6/63/Sri_Maha_Mariamman_Koyil_Bangkok_%28Wat_Khaek_Silom%29_2019_03.jpg",
        description: "วัดฮินดูชื่อดัง",
        googleMap: "https://maps.google.com/",
        appleMap: "https://maps.apple.com/",
        tags: ["ความรัก", "ธุรกิจ"],
        howToPray: "ธูป 9 ดอก",
        rating: 4.8,
        successRate: 82,
    ...
    {
        name: "วัดพระธาตุดอยคำ จังหวัดเชียงใหม่",
        image: "https://upload.wikimedia.org/wikipedia/commons/0/03/Wat_Phra_That_Doi_Kham_chedi.jpg",
        description: "วัดพระธาตุดอยคำ เป็นวัดเก่าแก่ที่มีอายุกว่า 1,300 ปี ตั้งอยู่ในตำบลแม่เหียะ บริเวณดอยคำ ด้านหลังอุทยานหลวงราชพฤกษ์ จังหวัดเชียงใหม่ ภายในวัดประดิษฐานหลวงพ่อพูดได้ พระพุทธรูปปางขัดสมาธิเพชรตามศิลปะเชียงแสน และพระธาตุดอยคำ ปูชนียสถานสำคัญคู่บ้านคู่เมืองเชียงใหม่ ซึ่งบรรจุพระบรมสารีริกธาตุขององค์สมเด็จพระสัมมาสัมพุทธเจ้า ไฮไลต์สำคัญที่สายมูไม่พลาดคือ หลวงพ่อทันใจ พระพุทธรูปศักดิ์สิทธิ์ที่สร้างขึ้นในสมัยพญากือนา เชื่อกันว่าขอพรแล้วเห็นผลรวดเร็ว โดยเฉพาะเรื่องการงาน การเงิน และความสำเร็จ เมื่อสมหวังดังปรารถนา ผู้คนนิยมถวายดอกมะลิเป็นการแก้บน",
        googleMap: "https://maps.google.com/",
        appleMap: "https://maps.apple.com/",
        tags: ["งาน"],
        howToPray: "จุดธูป 3 ดอก ตั้งจิตให้สงบ กล่าวนะโม 3 จบ บอกชื่อ-นามสกุลและสิ่งที่ต้องการ หากสำเร็จให้กลับมาถวายพวงมาลัยดอกมะลิอย่างน้อย 50 พวง",
        rating: 5,
        successRate: 80,
        successCount: 0,
        totalPrayerCount: 0,
    ...
    {
        name: "วัดบางนานอก",
        image: "https://upload.wikimedia.org/wikipedia/commons/3/31/Wat_Bangna-nok-1.jpg",
        description: "วัดบางนานอก ตั้งอยู่ ณ จุดที่แม่น้ำเจ้าพระยาและคลองบางนามาบรรจบกัน เป็นวัดเก่าแก่ที่ชาวบ้านเรียกเดิมว่าวัดปากคลองบางนา คำว่า 'นอก' สะท้อนตำแหน่งติดเส้นทางสัญจรทางน้ำสายหลัก ในความเชื่อโบราณ จุดบรรจบของสายน้ำเป็นพื้นที่แห่งพลังงาน ความอุดมสมบูรณ์ และการเริ่มต้นใหม่ ปัจจุบันผู้คนยังนิยมมาสักการะ ทำบุญ และปล่อยปลาริมแม่น้ำเจ้าพระยา",
        googleMap: "",
        appleMap: "",
        tags: ["ด้านการงานและโอกาสใหม่ ด้านการเงิน ด้านชีวิตและความสัมพันธ์"],
        howToPray: "ตั้งจิตให้สงบ จุดธูป 3 ดอก เทียน 1 คู่ กล่าวนะโม 3 จบ บอกชื่อ-นามสกุลและสิ่งที่ปรารถนา ทำบุญตามกำลังศรัทธา เช่น ถวายสังฆทานหรือปล่อยปลา อุทิศบุญกุศลให้บิดามารดาและเจ้ากรรมนายเวร",
        rating: 3.5,
        successRate: 76,
        successCount: 0,
        totalPrayerCount: 0,
    ...
    {
        name: "ศาลเจ้าแม่ทับทิม (สะพานเหลือง)",
        image: "https://upload.wikimedia.org/wikipedia/commons/b/b2/%E0%B8%A8%E0%B8%B2%E0%B8%A5%E0%B9%80%E0%B8%88%E0%B9%89%E0%B8%B2%E0%B9%81%E0%B8%A1%E0%B9%88%E0%B8%97%E0%B8%B1%E0%B8%9A%E0%B8%97%E0%B8%B4%E0%B8%A1_Tub_Tim_Shrine_%281%29.jpg",
        description: "",
        googleMap: "",
        appleMap: "",
        tags: ["งาน", "ความสำเร็จ", "ธุรกิจ"],
        howToPray: "",
        rating: 5,
        successRate: 95,
        successCount: 1,
